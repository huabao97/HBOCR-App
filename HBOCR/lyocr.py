...
notebook.add(frameOne, text='文字识别')
notebook.add(frameTwo, text='表格识别')
notebook.add(frameThree, text='公式识别')
notebook.add(frameFour, text='二维码识别')
...
ocrlable = tk.Label(framesetleft,text='项目地址：',font=('微软雅黑', 15), width=10, height=2)
ocrlable.pack(padx=15,pady=15,anchor=NW)
github = tk.Label(framesetleft,text='Github: https://github.com/huabao97',width=50,height=2)
github.pack(anchor=NW,padx=5,pady=10)
gitee = tk.Label(framesetleft,text='Gitee: https://gitee.com/huabao970716',width=50,height=2)
...
apibutton = tk.Button(framesetright,text='API设置',font=('微软雅黑', 15), width=15, height=3,relief='groove',bg='Azure',activebackground='Azure',command=apisetting)
